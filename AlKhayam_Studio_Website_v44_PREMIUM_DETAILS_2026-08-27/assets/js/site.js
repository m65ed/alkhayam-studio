...
(()=>{
  ...
  if(floating&&toggle&&menu){
    ...
    document.querySelectorAll('[data-open-branch-contact]').forEach(btn=>btn.addEventListener('click',()=>{floating.classList.add('open');toggle.setAttribute('aria-expanded','true');toggle.focus({preventScroll:true})}));
  }
})();
